//@CodeCopy
#if ACCOUNT_ON
using eVaccinationPass.Logic.Entities.Account;
using eVaccinationPass.Logic.Modules.Exceptions;
using eVaccinationPass.Logic.Modules.Security;
using System.Text;
using System.Text.RegularExpressions;

namespace eVaccinationPass.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using eVaccinationPass.Common.Modules.ThreadSafe;
