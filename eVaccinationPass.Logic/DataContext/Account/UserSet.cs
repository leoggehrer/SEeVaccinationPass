...
namespace eVaccinationPass.Logic.DataContext.Account
{
    ...
    using TContract = eVaccinationPass.Logic.Contracts.Account.IUser;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class UserSet : EntitySet<TEntity>, Contracts.Account.IUserSet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserSet"/> class (created by the generator.)
        /// </summary>
        public UserSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
