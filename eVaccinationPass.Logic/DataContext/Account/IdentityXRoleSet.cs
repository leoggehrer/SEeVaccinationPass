...
namespace eVaccinationPass.Logic.DataContext.Account
{
    ...
    using TContract = eVaccinationPass.Logic.Contracts.Account.IIdentityXRole;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class IdentityXRoleSet : EntitySet<TEntity>, Contracts.Account.IIdentityXRoleSet
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static IdentityXRoleSet()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityXRoleSet"/> class (created by the generator.)
        /// </summary>
        public IdentityXRoleSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
