...
namespace eVaccinationPass.Logic.DataContext.Account
{
    ...
    using TContract = eVaccinationPass.Logic.Contracts.Account.ILoginSession;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class LoginSessionSet : EntitySet<TEntity>, Contracts.Account.ILoginSessionSet
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static LoginSessionSet()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoginSessionSet"/> class (created by the generator.)
        /// </summary>
        public LoginSessionSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
