...
namespace eVaccinationPass.Logic.DataContext.Account
{
    ...
    using TContract = eVaccinationPass.Logic.Contracts.Account.IIdentity;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class IdentitySet : EntitySet<TEntity>, Contracts.Account.IIdentitySet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentitySet"/> class (created by the generator.)
        /// </summary>
        public IdentitySet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
