...
namespace eVaccinationPass.Logic.DataContext.Account
{
    ...
    using TContract = eVaccinationPass.Logic.Contracts.Account.ISecureIdentity;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class SecureIdentitySet : EntitySet<TEntity>, Contracts.Account.ISecureIdentitySet
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static SecureIdentitySet()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SecureIdentitySet"/> class (created by the generator.)
        /// </summary>
        public SecureIdentitySet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
