//@CodeCopy
using eVaccinationPass.Common.Modules.Exceptions;
...
{
    /// <summary>
    /// Represents the database context for the eVaccinationPass application.
    /// </summary>
    internal sealed partial class ProjectDbContext : DbContext, IContext
    {
        ...
        /// </summary>
        private static readonly string ConnectionString = "data source=eVaccinationPass.db";
        #endregion fields
