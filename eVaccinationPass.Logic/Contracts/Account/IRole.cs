...
namespace eVaccinationPass.Logic.Contracts.Account
{
    ...
    /// </summary>
    internal partial interface IRole : CommonContracts.IVersionable
    {
        ...
        void CopyProperties(IRole other)
        {
            bool handled = false;
        ...
        partial void BeforeCopyProperties(IRole other, ref bool handled);
        /// <summary>
        ...
        partial void AfterCopyProperties(IRole other);
    }
}
